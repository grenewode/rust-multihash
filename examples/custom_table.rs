...
pub enum Multihash {
    ...
    Sha2_256Truncated20(multihash::Sha2Digest<U20>),
    /// Example for using a hasher with a bit size that is not exported by default
    #[mh(code = BLAKE2B_200, hasher = multihash::Blake2bHasher::<U25>)]
    Blake2b200(multihash::Blake2bDigest<U25>),
    /// Example of using a number as code value
    #[mh(code = 0xb214, hasher = multihash::Blake2bHasher::<U20>)]
    ByCode(multihash::Blake2bDigest<U20>),
}
